...
function widget.new()
                ...
                {
                    {
                        {
                            {
                                markup = '<span font="awesomewm-font 14" color="#ffffff"></span>',
                    ...
                    shape_border_color = beautiful.hotkeys_border_color,
    ...
    function widget_instance:launch()
        ...
        w.visible = true
        awful.placement.top(w, { parent = awful.screen.focused() })
        awful.prompt.run {
            prompt = 'Run: ',
